...
public class ReverseIntegers {
	...
	/*
	 * public boolean containsChar (String s, char isNeg ) { isNeg = '-'; if
	 * (s.length() == isNeg) { return true; } return false; }
	 */
	...
	String newStr = sb.reverse().toString();		//<-------Using the reverse method from stringBuilder on renamed string value "sb" string that holds the #'s inna string 
	 ...
	 int z = Integer.parseInt(newStr);				//<-------this line is essentially just turns the reversed string that 
